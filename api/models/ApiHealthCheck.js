...
var defaultModel = _.merge(_.cloneDeep(require("../base/Model")), {
  ...
  afterUpdate: function (values, cb) {
    ...
    if (values.active) {
      ...
      sails.log(
        new Date(),
        "ApiHealthCheck:afterUpdate:emit api.health_checks.start"
      );
      ...
      sails.log(
        new Date(),
        "ApiHealthCheck:afterUpdate:emit api.health_checks.stop"
      );
...
module.exports =
  sails.config.models.connection == "mongo" ? mongoModel() : defaultModel;
